...
public interface EosApiService {
    ...
    @POST("/v1/chain/get_account")
    Call<JsonNode> getAccountByName(@Body Map<String, String> requestFields);

    @POST("/v1/chain/get_code")
    Call<Code> getCode(@Body Map<String, String> requestFields);

    @POST("/v1/chain/get_table_rows")
    Call<TableRow> getTableRows(@Body Map<String, Object> requestFields);

    @POST("/v1/chain/get_table_rows")
    Call<JsonNode> getSpecialTableRows(@Body Map<String, Object> requestFields);
    ...
    @POST("/v1/chain/push_transaction")
    Call<JsonNode> pushTransaction(@Body client.crypto.model.chain.PackedTransaction body);

    @POST("/v1/chain/push_transactions")
    Call<List<JsonNode>> pushTransactions(@Body List<client.crypto.model.chain.PackedTransaction> bodys);
    ...
    @POST("/{version}/Accounts/{accountSid}/Calls/voiceNotify?sig={sigParameter}")
    Call<VoiceNotifyRsp> sendVoiceNotify(@Header("Authorization") String auth,
                                         @Query("version") String version, @Query("accountSid") String accountSid,
                                         @Query("sigParameter") String sigParameter, @Body VoiceNotifyReq voiceNotifyReq);
}
