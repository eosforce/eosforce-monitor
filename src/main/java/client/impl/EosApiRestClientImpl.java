...
public class EosApiRestClientImpl implements EosApiRestClient {
    ...
    @Override
    public JsonNode getAccountByName(String accountName) {
        return EosApiServiceGenerator.executeSync(eosApiService.getAccountByName(Collections.singletonMap("account_name", accountName)));
    }
    ...
    @Override
    public TableRow getTableRows(String scope, String code, String table, String accountName) {
        ...
        requestParameters.put("table_key", accountName);
        requestParameters.put("json", "true");
        requestParameters.put("limit", 5);

        return EosApiServiceGenerator.executeSync(eosApiService.getTableRows(requestParameters));
    }

    @Override
    public TableRow getTableRows(LinkedHashMap<String, Object> requestParameters) {
        return EosApiServiceGenerator.executeSync(eosApiService.getTableRows(requestParameters));
    }

    @Override
    public JsonNode getSpecialTableRows(LinkedHashMap<String, Object> parameters) {
        return EosApiServiceGenerator.executeSync(eosApiService.getSpecialTableRows(parameters));
    }
    ...
    @Override
    public List<JsonNode> pushTransactions(List<client.crypto.model.chain.PackedTransaction> pushTransactionRequests) {
    ...
    @Override
    public VoiceNotifyRsp sendVoiceNotify(String auth, String version, String accountSid, String sigParameter, VoiceNotifyReq voiceNotifyReq) {
        return EosApiServiceGenerator.executeSync(eosApiService.sendVoiceNotify(auth, version, accountSid, sigParameter, voiceNotifyReq));
    }
